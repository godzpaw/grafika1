...
float windowPos[7][3] = { {0.2,-0.3, 0.51}, {-0.2, -0.3, 0.51},{ 0.2,-0.8, 0.51 },{ -0.2, -0.8, 0.51 },{ 0.2,-0.3, -0.51 } };
...
void GenerateTextures()
{
	...
	// wczytanie tekstury NW_City_Wall_02.tga
	error = load_targa("NW_City_Wall_02.tga", width, height, format, type, pixels);

	// błąd odczytu pliku
	if (error == GL_FALSE)
	{
		printf("Niepoprawny odczyt pliku NW_City_Wall_02.tga");
		//exit(0);
	}
